...
public class Ristorante {
     ...
     */
    public Ristorante(int id_ristorante, String nome, String indirizzo, double latitudine,
                      double longitudine, int prezzoMedio, boolean delivery, boolean prenotazione, String tipoCucina,
                      Double stelle, String proprietario, int id_citta){
    ...
    public int getId_citta(){return id_citta;}

    //setter

   public void setId_ristorante(int idRistorante){this.id_ristorante = idRistorante;}
    ...
    public void setId_citta(int idCitta){this.id_citta = idCitta;}
    ...
    public String toString(){
        return "" +"idRistorante" + id_ristorante +
                "\nRistorante: " + nome +
                "\nIndirizzo: " + indirizzo +
